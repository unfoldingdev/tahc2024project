...
const u8 gText_DefaultNameStu[] = _("CHELSEA");
const u8 gText_DefaultNameMilton[] = _("CHEL   ");
...
const u8 gText_DefaultNameKimmy[] = _("CHELSEA");
const u8 gText_DefaultNameTiara[] = _("CHEL   ");
...
const u8 gText_CantDismountBike[] = _("There's no water, so how could you\nuse a fishing rod?\p...\pI guess you could be fishing for\ncompliments?\pUm... You're... You're playing well?\pAnd you're probably attractive?\pI don't know for sure, but the way you\npress buttons so firmly and decisively\lmakes me a little weak in the knees.\pAnd you're so thorough in exploration!\pAny game would be lucky to have you!{PAUSE_UNTIL_PRESS}");
